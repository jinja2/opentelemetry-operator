...
func HandleReconcileStatus(ctx context.Context, log logr.Logger, params manifests.Params, err error) (ctrl.Result, error) {
	...
	statusErr := updateClusterObservabilityStatus(ctx, params.Client, changed, isConflicted)
	if statusErr != nil {
...
func updateClusterObservabilityStatus(ctx context.Context, cli client.Client, co *v1alpha1.ClusterObservability, isConflicted bool) error {
